...
###  VS Code、WebStorm、Sublime Text 和 Atom 用哪个好?

- 其实不用去对比, 适合自己的就是最好的. 
- 如果是初学者,还没用过编辑器或IDE, 那就直接用 VS Code, 如果电脑比较卡顿, 那么就用Sublime Text.
...
VS Code 的安装很简单，直接去官网下载安装包，下载适合自己的系统的版本, 然后双击安装即可。


![](http://blog.oss.yeetu.com/230908/00.png)
...
| **Cmd + +、Cmd + -** | **ctrl + +、ctrl + -**  | 将工作区放大/缩小（包括代码字体、左侧导航栏） | 实用 |
